...
import Authentication from "./componets/LoginPopup/LoginPopup.jsx";
    ...
    return (
        ...
        <>
            ...
            <div className='app'>
                ...
                <Navbar isAuthenticated={isAuthenticated} setShowDoorModal={setShowDoorModal} setShowModal={setShowModal}/>
